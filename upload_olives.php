...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $name = "Olives";
    $description = "The recycling of olive pits is an innovative and sustainable practice with multiple benefits. Olive pits can be processed into biofuels, providing a renewable energy source. They are also used to create activated carbon, which is employed in water purification and air filtration. Additionally, olive pit waste is repurposed into biodegradable plastics and natural exfoliants in cosmetics. This recycling not only reduces waste but also promotes the use of eco-friendly materials in various industries.";
...
<head>
    ...
    <title>Upload Olives Product - No Waste</title>
    ...
    <div class="container">
        ...
        <div>
            <div style="float:left;width:24%;">
                <img class="product-image" src="img/olives.jpg" alt="Olives">
                <p>&nbsp;The recycling of live pits is an innovative and sustainable practice with multiple benefits. Olive pits can be processed into biofuels, providing a renewable energy source. They are also used to create activated carbon, which is employed in water purification and air filtration. Additionally, olive pit waste is repurposed into biodegradable plastics and natural exfoliants in cosmetics. This recycling not only reduces waste but also promotes the use of eco-friendly materials in various industries.</p>
            </div>
            <div>
                <div style="float:right;width:70%;">
                <form action="upload_olives.php" method="post" enctype="multipart/form-data">
