...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $name = "Orange Peel";
    $description = "Orange peel, often overlooked as merely the outer layer of the fruit, offers numerous benefits across health, culinary, and cleaning domains. Rich in vitamin C and antioxidants, it strengthens the immune system and combats oxidative stress. In the kitchen, orange zest enhances the flavor of cakes, cookies, and marmalades, while dried and powdered peel can be used as a spice. Additionally, orange peel serves as a natural cleaning agent, thanks to its essential oils, making it a versatile and valuable component in daily life.";
...
<head>
    ...
    <title>Upload Orange Product - No Waste</title>
        ...
        function updateScoresAndPrice() {
            ...
            switch (conversionMethod) {
                ...
                case 'Cleaning Agents':
                    ...
                    pricePerKg = 100;
                    break;
                case 'Water Purification Agents':
                    economicScore = 5;
                    socialScore = 5;
                    environmentalScore = 4;
                    pricePerKg = 35;
    ...
    <div class="container">
        ...
        <div>
            <div style="float:left;width:24%;">
                <img class="product-image" src="img/orange.jpg" alt="Orange Peel">
                <p>&nbsp;Orange peel, often overlooked as merely the outer layer of the fruit, offers numerous benefits across health, culinary, and cleaning domains. Rich in vitamin C and antioxidants, it strengthens the immune system and combats oxidative stress. In the kitchen, orange zest enhances the flavor of cakes, cookies, and marmalades, while dried and powdered peel can be used as a spice. Additionally, orange peel serves as a natural cleaning agent, thanks to its essential oils, making it a versatile and valuable component in daily life.</p>
            </div>
            <div>
                <div style="float:right;width:70%;">
                <form action="upload_orange.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="conversionMethods" name="conversion_method" onchange="updateScoresAndPrice()" required>
                        ...
                        <option value="Water Purification Agents">Water Purification Agents</option>
                    </select>
                    </div>
                    <div class="separator">
                    <h4>Price</h4>
